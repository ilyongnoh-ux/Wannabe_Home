...
<h3 style="color: #FFFFFF; font-size: 2rem; text-shadow: 0px 2px 4px rgba(0,0,0,0.9), 0px 0px 20px rgba(0,0,0,0.8); font-weight: 800; margin-top: 0;">당신의 평생 금융파트너,  한국금융투자기술(KFIT)®</h3>
</div>
</div>
    """,
    unsafe_allow_html=True,
